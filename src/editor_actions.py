...
def add_clips_to_timeline(clip_names):
    if is_api_available():
        ...
        if project:
            ...
            # Build a lookup map of clip name/path to the clip object
            # To preserve original 'first-match' behavior, we iterate
            # backwards and overwrite so that the first occurrence in the
            # original list remains in the dictionary.
            clip_map = {}
