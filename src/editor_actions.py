...
def add_clips_to_timeline(clip_names):
    if is_api_available():
        ...
        if project:
            ...
            # Optimization: Use a hash map to index clips by name and basename.
            # This reduces complexity from O(N*M) to O(N+M), which is significant
            # for large media pools.
            clip_map = {}
            for clip in all_clips:
                ...
                # Also index by basename if path is available
