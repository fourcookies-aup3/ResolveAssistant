    ...
    if is_api_available():
        ...
        if project:
            ...
            for clip in reversed(all_clips):
                # By iterating in reverse, the first occurrence in the original
                # list will be the last one written to the map, preserving
                # the "first-match" behavior of the original loop.
